...
class UserRouter extends _classes_1.Router {
    constructor() {
        super();
    }
    /**
    ...
    define() {
        this.router
             ...
             *
             */
            .get(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.listUsers), user_controller_1.UserController.list)
            /**
             ...
             *
             */
            .post(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.createUser), user_controller_1.UserController.create);
        this.router
            .route('/profile')
            /**
             ...
             * }
             */
            .get(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin, _enums_1.ROLE.user]), user_controller_1.UserController.loggedIn);
        this.router
            .route('/:userId(\\d+)')
            /**
             ...
             *
             */
            .get(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.getUser), user_controller_1.UserController.get)
            /**
             ...
             *
             */
            .put(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.replaceUser), user_controller_1.UserController.update)
            /**
             ...
             *
             */
            .patch(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.updateUser), user_controller_1.UserController.update)
            /**
             ...
             *
             */
            .delete(guard_middleware_1.Guard.authorize([_enums_1.ROLE.admin]), validator_middleware_1.Validator.check(user_validation_1.removeUser), user_controller_1.UserController.remove);
    }
}
