...
import { IHTTPError } from './IHTTPError.interface';
import { IMedia } from './IMedia.interface';
import { IMediaQueryString } from './IMediaQueryString.interface';
import { IMediaRequest } from './IMediaRequest.interface';
...
import { ITokenOptions } from './ITokenOptions.interface';
import { IUpload } from './IUpload.interface';
import { IUploadMulterOptions } from './IUploadMulterOptions.interface';
import { IUploadOptions } from './IUploadOptions.interface';
