...
const { DatabaseConfiguration } = require(process.cwd() + '/dist/api/config/database.config');
...
describe('Config', function () {
  ...
  describe('Typeorm', () => {
    ...
    it('DatabaseConfiguration.connect() should failed', async () => {  
      const options = clone(TYPEORM);
      options.TYPE = 'yoda';
      options.NAME = 'yoda';
      await DatabaseConfiguration.connect(options).catch(e => {
