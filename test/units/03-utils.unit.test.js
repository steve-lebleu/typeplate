...
describe('Utils', () => {
  ...
  describe('Date', () => {
    ...
    describe('getAge()', () => {
      ...
      xit('should return right age as a number', function(done) {
        const result = getAge(new Date(1979,8,28).toDateString());
        expect(result).to.eqls(new Date().getUTCFullYear() - 1979);
        done();
      });
